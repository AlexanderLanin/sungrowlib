...
| [ha-sungrow](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml) | 258 | 250 | 0 | 77 |
...
| Address | Type | Register | Field | Ours | Theirs |
|--------:|------|----------|-------|------|--------|
| [13052](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L2657) | hold | charge_discharge_power / battery_forced_charge_discharge_power | unit | W | % |
| [4954](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L36) | read | arm_software_version | data_type | UTF-8 | U16 |
| [4969](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L41) | read | dsp_software_version | data_type | UTF-8 | U16 |
| [5726](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L791) | read | total_backup_power / backup_power_total | data_type | S32 | S16 |
| [13050](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1847) | read | inverter_alarm | scale | None | 0.1 |
| [13052](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1853) | read | grid_side_fault / grid-side_fault | scale | None | 0.1 |
| [13054](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1859) | read | system_fault_1 / system_fault1 | scale | None | 0.1 |
| [13056](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1865) | read | system_fault_2 / system_fault2 | scale | None | 0.1 |
| [13058](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1871) | read | dc_side_fault / dc-side_fault | scale | None | 0.1 |
| [13060](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1877) | read | permanent_fault | scale | None | 0.1 |
| [13062](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1883) | read | bdc_side_fault / bdc-side_fault | scale | None | 0.1 |
| [13064](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1889) | read | bdc_side_permanent_fault / bdc-side_permanent_fault | scale | None | 0.1 |
| [13066](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1895) | read | battery_fault | scale | None | 0.1 |
| [13068](https://github.com/AlexanderLanin/homeassistant-sungrow/blob/main/custom_components/sungrow/core/registers-sungrow.yaml#L1902) | read | battery_alarm | scale | None | 0.1 |
